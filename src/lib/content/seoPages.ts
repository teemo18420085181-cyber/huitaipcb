...
export const seoPages: Record<string, SeoLandingPage> = {
  ...
  'bom-sourcing-pcb-assembly': {
    ...
    metaDescription: 'BOM sourcing and PCB assembly for overseas projects — MPN and availability checks, approved alternatives, purchasing, and assembly in one workflow. Engineer-reviewed, reply in 24h.',
