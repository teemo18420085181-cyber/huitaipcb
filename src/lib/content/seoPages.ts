...
export const seoPages: Record<string, SeoLandingPage> = {
  ...
  'china-pcb-assembly': {
    ...
    metaDescription: 'China PCBA assembly service for overseas B2B customers, covering PCB fabrication coordination, BOM sourcing, SMT assembly, DIP assembly, inspection, testing, and finished PCBA delivery.',
  ...
  'prototype-pcb-assembly': {
    ...
    metaDescription: 'Prototype PCBA manufacturing in China for engineers, startups, and product developers needing Gerber and BOM review, component sourcing, SMT assembly, testing scope confirmation, and delivery.',
