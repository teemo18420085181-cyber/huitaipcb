  ...
  'china-pcb-assembly': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'A useful first review usually starts with Gerber and drill files, a BOM with manufacturer part numbers, quantity, and any test or acceptance notes. If the design is not complete, send a partial BOM, sample photos, board markings, or an older file set so we can identify what is missing before a formal quote.',
      },
      {
      ...
      },
      {
        ...
        body: 'Working with a China PCB assembly service should not mean unclear email threads. Overseas buyers work with English-speaking support on file review, manufacturability questions, BOM risk, test scope, and quote assumptions, so the next step is easier to understand before the build starts.',
      },
      {
        heading: 'How Quality Is Verified Before Shipment',
        body: 'Quality is the real question behind choosing any China PCB assembly supplier. Inspection and test scope should be discussed before production rather than assumed. Depending on the project, this may include visual inspection, AOI, selected X-ray review, electrical checks, or functional testing against customer-provided firmware and acceptance criteria.',
      },
    ],
    ...
    sections: [
      {
        ...
        body: 'The first question is simple: can the BOM be sourced for the quantity and schedule you need? We review manufacturer part numbers, package match, lifecycle status, shortage risk, and possible alternates. Any substitute part must be confirmed by the customer before purchasing.',
      },
      {
        heading: 'What We Check Before a PCBA Quote',
        body: 'A BOM review looks for missing MPNs, wrong packages, single-source parts, obsolete components, long-lead items, minimum order quantities, and parts that may need programming or special handling. These items often decide whether a PCBA quote is realistic or only a placeholder.',
      },
      {
        heading: 'Component Availability and Lifecycle Check',
        body: 'Component availability can change quickly. We check sourcing options before quotation when possible and flag parts that are obsolete, long-lead, single-source, or unstable in price. The goal is to surface the few risky lines early instead of finding them after assembly planning starts.',
      },
      {
        heading: 'Alternatives and Substitute Confirmation',
        body: 'When a part is hard to source, we may suggest sourcing options or functionally suitable alternatives. Substitutions are never made silently. The customer reviews the proposed alternate, electrical fit, package, brand preference, and approval status before purchasing and assembly.',
      },
      {
      ...
      {
        heading: 'How BOM Sourcing Affects Cost and Schedule',
        body: 'Component cost is often the largest part of a PCBA quote, and a single long-lead or single-source part can delay the whole build. A clean BOM with approved alternates helps the sourcing plan, assembly scope, and schedule discussion stay realistic.',
      },
      {
        heading: 'Quoting From a BOM Without Gerber Files',
        body: 'You can ask for a preliminary review from a BOM even if your Gerber files are not ready. A BOM alone lets us review component cost, availability, and sourcing risk. A firm PCBA quote still needs Gerber and pick-and-place data, but a BOM-first review tells you early whether the sourcing side is likely to be workable.',
      },
      {
