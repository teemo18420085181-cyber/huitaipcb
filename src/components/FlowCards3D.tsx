...
const FilesAnim = () => (
  <svg viewBox="0 0 180 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    {/* Gerber traces */}
    <polyline points="45,35 60,35 60,50 75,50 75,35 90,35" stroke="#E6A85A" strokeWidth="1.5" strokeLinecap="round">
      <animate attributeName="stroke-dasharray" values="0,200;200,0" dur="2s" repeatCount="indefinite"/>
    </polyline>
    <polyline points="95,55 110,55 110,40 125,40 125,65 140,65" stroke="#E6A85A" strokeWidth="1.5" strokeLinecap="round">
      <animate attributeName="stroke-dasharray" values="0,200;200,0" dur="2s" begin="0.5s" repeatCount="indefinite"/>
    </polyline>
    {/* Scan line */}
    <line x1="35" y1="50" x2="145" y2="50" stroke="#9EE34F" strokeWidth="1" opacity="0.6">
    ...
    <g fontSize="8" fontFamily="monospace">
      <text x="40" y="75" fill="#9EE34F">✓ Clearance OK</text>
      <text x="40" y="85" fill="#9EE34F">
        ✓ Via size OK
    ...
    {/* Engineer silhouette */}
    <circle cx="160" cy="45" r="11" fill="#27215B" stroke="#9EE34F" strokeWidth="1.5"/>
    <path d="M149 57 Q160 51 171 57 L173 90 L147 90 Z" fill="#27215B" stroke="#9EE34F" strokeWidth="1.5"/>
    {/* Arm pointing */}
    <line x1="149" y1="72" x2="135" y2="57" stroke="#9EE34F" strokeWidth="2" strokeLinecap="round">
      <animateTransform attributeName="transform" type="rotate" values="0 149 72;-8 149 72;0 149 72" dur="2s" repeatCount="indefinite"/>
    </line>
    {/* Label */}
    <text x="90" y="138" fill="#E6A85A" fontSize="10" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif">DFM REVIEW</text>
...
const PCBFabAnim = () => (
  <svg viewBox="0 0 180 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    <polyline points="40,50 70,50 70,80 100,80 100,50 130,50 130,110 100,110 100,80" stroke="#C98B3A" strokeWidth="2.5" strokeLinecap="round">
      <animate attributeName="stroke-dasharray" values="0,400;400,0" dur="2.5s" repeatCount="indefinite"/>
    </polyline>
    <polyline points="40,110 70,110 70,80" stroke="#C98B3A" strokeWidth="2.5" strokeLinecap="round">
    ...
    {/* Label */}
    <text x="90" y="145" fill="#E6A85A" fontSize="10" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif">PCB FABRICATION</text>
...
const BOMSourceAnim = () => (
  <svg viewBox="0 0 180 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    {[25,55,85,115,145].map((x,i) => (
      <g key={i}>
        <circle cx={x} cy="55" r="12" fill="#1A1640" stroke="#E6A85A" strokeWidth="1.5">
    ...
    {[25,65,105,145].map((x,i) => (
      <g key={i}>
        <circle cx={x} cy="85" r="10" fill="#1A1640" stroke="#9EE34F" strokeWidth="1.5">
    ...
    {/* Picking arm */}
    <line x1="90" y1="10" x2="90" y2="40" stroke="#E6A85A" strokeWidth="2.5">
    ...
    <circle cx="90" cy="40" r="5" fill="#E6A85A">
...
const SMTAnim = () => (
  <svg viewBox="0 0 180 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    {/* Vertical arm */}
    <line x1="90" y1="20" x2="90" y2="70" stroke="#E6A85A" strokeWidth="2.5">
    ...
    {/* Nozzle head */}
    <polygon points="85,70 95,70 92,78 88,78" fill="#E6A85A">
    ...
    <rect x="85" y="30" width="10" height="6" rx="1" fill="#9EE34F">
    ...
    {/* Tape reels */}
    <circle cx="25" cy="50" r="18" fill="#1A1640" stroke="#E6A85A" strokeWidth="1.5">
    ...
    <circle cx="155" cy="50" r="14" fill="#1A1640" stroke="#9EE34F" strokeWidth="1.5">
    ...
    {/* Label */}
    <text x="90" y="153" fill="#E6A85A" fontSize="10" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif">SMT ASSEMBLY</text>
...
const TestingAnim = () => (
  <svg viewBox="0 0 180 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    {/* Waveform */}
    <polyline stroke="#E6A85A" strokeWidth="1.5" fill="none" strokeLinecap="round"
    ...
    {/* Test probe */}
    <line x1="120" y1="120" x2="85" y2="95" stroke="#9EE34F" strokeWidth="2" strokeLinecap="round"/>
    <circle cx="120" cy="120" r="3" fill="#9EE34F"/>
    {/* PCB under test */}
    <rect x="60" y="100" width="80" height="45" rx="3" fill="#0a3d2a" stroke="#1a7a55" strokeWidth="1"/>
    {/* LED indicators */}
    <circle cx="75" cy="113" r="4" fill="#9EE34F">
      <animate attributeName="opacity" values="1;0.2;1" dur="0.8s" repeatCount="indefinite"/>
    </circle>
    <circle cx="90" cy="113" r="4" fill="#9EE34F">
      <animate attributeName="opacity" values="0.2;1;0.2" dur="0.8s" repeatCount="indefinite"/>
    </circle>
    {/* PASS badge */}
    <rect x="100" y="107" width="35" height="16" rx="3" fill="#9EE34F">
    ...
    {/* Label */}
    <text x="90" y="155" fill="#E6A85A" fontSize="10" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif">TESTING</text>
  ...
  <svg viewBox="0 0 180 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    {[45,75,105,135].map((x,i) => (
      <g key={i}>
        ...
        <text x={x} y="82" fill="#9EE34F" fontSize="10" textAnchor="middle" fontFamily="sans-serif">
          ✓
    ...
    {/* Magnifying glass */}
    <circle cx="90" cy="40" r="25" fill="#1A1640" fillOpacity="0.7" stroke="#E6A85A" strokeWidth="2.5">
      <animate attributeName="cx" values="45;135;45" dur="4s" repeatCount="indefinite"/>
    </circle>
    <circle cx="90" cy="40" r="18" fill="none" stroke="#E6A85A" strokeWidth="1" strokeDasharray="2,2">
      <animate attributeName="cx" values="45;135;45" dur="4s" repeatCount="indefinite"/>
      <animateTransform attributeName="transform" type="rotate" values="0 90 40;360 90 40" dur="3s" repeatCount="indefinite"/>
    </circle>
    {/* Handle */}
    <line x1="110" y1="60" x2="125" y2="75" stroke="#E6A85A" strokeWidth="3" strokeLinecap="round">
    ...
    <text x="57" y="134" fill="#9EE34F" fontSize="6" textAnchor="middle" fontFamily="monospace">PASS ✓</text>
    {/* Label */}
    <text x="90" y="155" fill="#E6A85A" fontSize="10" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif">QUALITY CONTROL</text>
...
const ShippingAnim = () => (
  <svg viewBox="0 0 180 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    <polyline points="60,110 75,110 75,125 90,125 90,110 105,110" stroke="#C98B3A" strokeWidth="1.5"/>
    {/* Box lid closing */}
    ...
    {/* Tape */}
    <rect x="75" y="70" width="30" height="5" rx="1" fill="#E6A85A" opacity="0.8">
    ...
    <text x="70" y="123" fill="#E6A85A" fontSize="10" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif">DHL</text>
    {/* Airplane */}
    <g>
      <animateTransform attributeName="transform" type="translate" values="-30,0;210,0" dur="3s" repeatCount="indefinite"/>
      <polygon points="150,30 170,40 150,50 145,40" fill="#E6A85A"/>
      <line x1="145" y1="40" x2="130" y2="35" stroke="#E6A85A" strokeWidth="2"/>
      <line x1="145" y1="40" x2="130" y2="45" stroke="#E6A85A" strokeWidth="2"/>
    </g>
    {/* Global delivery badge */}
    <circle cx="155" cy="100" r="18" fill="#27215B" stroke="#E6A85A" strokeWidth="1.5"/>
    <text x="155" y="97" fill="#E6A85A" fontSize="9" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif">Global</text>
    <text x="155" y="107" fill="#fff" fontSize="6" textAnchor="middle" fontFamily="sans-serif">countries</text>
    {/* Label */}
    <text x="90" y="158" fill="#E6A85A" fontSize="10" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif">SHIPPING</text>
...
const STEPS = [
  ...
  },
  {
    ...
    color: '#E6A85A', Anim: ShippingAnim,
  },
];
...
function FlowCard({ step, index }: { step: typeof STEPS[0]; index: number }) {
  ...
  return (
    <div
      ...
      className="relative flex-shrink-0 w-48 h-72 rounded-2xl overflow-hidden cursor-pointer border border-white/10 bg-cc-carbon-2 select-none"
    >
      {/* Connector line to next */}
      {index < STEPS.length - 1 && (
        <div className="absolute right-0 top-1/2 w-6 h-0.5 bg-cc-copper/30 translate-x-full -translate-y-0.5 z-10" />
      )}
      ...
      <div
        className="absolute inset-0 flex flex-col transition-opacity duration-300 bg-cc-carbon-2"
...
export default function FlowCards3D() {
  return (
    <section className="py-20 px-[5vw] bg-cc-carbon-2 overflow-hidden">
      <div className="max-w-[1280px] mx-auto">
        {/* Header */}
        <div className="font-body-cc mb-14 text-center">
          <div className="font-mono-cc mb-4 inline-flex items-center gap-2 text-[11px] font-semibold tracking-[0.2em] text-cc-copper-soft">
            <span className="h-px w-4 bg-cc-copper" />
            INTERACTIVE PROCESS
            <span className="h-px w-4 bg-cc-copper" />
          </div>
          <h2 className="font-display mb-3 text-3xl font-bold tracking-tight text-cc-ink md:text-4xl">
            Hover each step to see <span className="cc-copper-text">inside the process.</span>
          </h2>
          <p className="mx-auto max-w-[520px] text-sm text-cc-ink-mute">
              ...
              <div key={step.n} className="snap-start flex-shrink-0 flex items-center gap-0">
                ...
                {i < STEPS.length - 1 && (
                  <div className="flex-shrink-0 w-6 flex items-center justify-center">
                    <div className="w-full h-0.5 bg-gradient-to-r from-cc-copper/40 to-cc-signal/40" />
                  </div>
                )}
              </div>
            ))}
