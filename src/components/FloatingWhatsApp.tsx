...
export default function FloatingWhatsApp() {
  ...
  const isContactPage = pathname ? MOBILE_CONTACT_PATHS.has(pathname) : false;
  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="whatsapp-tooltip pointer-events-none absolute right-full top-1/2 mr-3 whitespace-nowrap rounded-md bg-cc-carbon-2 px-3 py-2 text-xs font-semibold text-cc-ink shadow-lg"
      >
        Chat on WhatsApp
      </span>
