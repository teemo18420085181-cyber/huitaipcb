    ...
    <>
      ...
      <main className="pt-[100px] min-h-screen bg-bg px-[5vw] py-14">
        <article className="max-w-[860px] mx-auto bg-white border border-line rounded-2xl p-8 md:p-10">
          ...
          <h1 className="text-3xl font-semibold text-brand-primary mb-5">Privacy Policy</h1>
          <div className="space-y-5 text-sm text-ink-muted leading-7">
            ...
            <h2 className="text-lg font-semibold text-brand-primary">Information We Collect</h2>
            <p>
            ...
            <h2 className="text-lg font-semibold text-brand-primary">How We Use Information</h2>
            <p>
            ...
            <h2 className="text-lg font-semibold text-brand-primary">Project Files</h2>
            <p>
            ...
            <p>
              For privacy questions or file removal requests, contact us at <a href="mailto:teemo18420085181@gmail.com" className="text-brand-primary underline">teemo18420085181@gmail.com</a>.
            </p>
          </div>
        </article>
      </main>
