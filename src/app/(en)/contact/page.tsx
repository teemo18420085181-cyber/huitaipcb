            ...
            <div className="grid items-start gap-8 lg:grid-cols-[0.78fr_1.22fr] lg:gap-12">
              <div className="lg:sticky lg:top-28">
                ...
                <p className="mb-6 max-w-[520px] text-[15px] leading-relaxed text-cc-ink-mute">
                  ...
                  requirements, sample board photos, or project notes. Work directly with our
                  manufacturing team to confirm the scope across PCB fabrication, BOM sourcing,
                  SMT and through-hole assembly, testing, and finished PCBA delivery.
                </p>
                <Link
                  href="/how-we-work"
            ...
            <div className="mt-8 overflow-hidden rounded-2xl border border-cc-line bg-cc-carbon-2">
              <div className="flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between md:p-8">
                <div>
                  ...
                  <p className="mt-1 text-xs font-semibold text-cc-ink-mute">Current manufacturing facility</p>
                  <address lang="zh-CN" className="mt-1 max-w-[440px] text-sm not-italic leading-relaxed text-cc-ink-mute">
                    {COMPANY_PUBLIC_PROFILE.manufacturer.facilityAddress}
                  </address>
                </div>
                <a
              ...
              <div className="relative bg-[#eef1ed]">
                ...
                <div className="pointer-events-none absolute bottom-4 left-4 rounded-lg border border-cc-line bg-cc-carbon/95 px-4 py-3 text-xs text-cc-ink shadow-lg">
                  <strong className="block text-sm">GX12 manufacturing facility</strong>
